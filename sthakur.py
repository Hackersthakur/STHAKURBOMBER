...
def check_for_updates():
    ...
    fver = requests.get("https://github.com/Hackersthakur/STHAKURBOMBER/main/.version").text.strip()
    if fver != __VERSION__:
...
def notifyen():
    try:
        noti = requests.get("https://github.com/Hackersthakur/STHAKURBOMBER/main/.new").text.upper().strip()
        if len(noti) > 10:
